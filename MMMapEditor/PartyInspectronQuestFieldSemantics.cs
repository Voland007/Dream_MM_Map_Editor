...
{
    public static class PartyInspectronQuestFieldSemantics
    {
        public const int FieldOffset = 0x75;
        public const string FieldLabel = "счётчик квестов LORD INSPECTRON (+0x75)";
